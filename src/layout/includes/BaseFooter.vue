<template>
  <footer class="bg-gray-100 border-t border-gray-300 py-10 text-sm">
    ...
    >
      <div class="flex flex-wrap items-start justify-start">
        <div class="lg:w-1/4 w-full lg:mb-0 mb-6">
          <h5 class="font-semibold text-gray-700 mb-2">Genius Consult Tools</h5>
        ...
        <div class="lg:w-1/4 w-full lg:mb-0 mb-6">
          <h5 class="font-semibold text-gray-700 mb-2">Career Guide</h5>
          <ul class="leading-loose">
            <li>
              <a class="text-gray-600 hover:underline font-semibold" href="#"
                >Job Search Blogs</a
        ...
        <div class="lg:w-1/4 w-full lg:mb-0 mb-6">
          <h5 class="font-semibold text-gray-700 mb-2">About Us</h5>
          <ul class="leading-loose">
            <li>
              <a class="text-gray-600 hover:underline font-semibold" href="#"
                >Home</a
    ...
    <div class="max-w-5xl mx-auto flex items-center px-4 lg:px-0">
      <img
        src="@/assets/img/geniusConsultLogo.svg"
